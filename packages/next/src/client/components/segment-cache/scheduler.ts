      ...
      switch (segment.fetchStrategy) {
        ...
        case FetchStrategy.LoadingBoundary:
          ...
          if (background(task)) {
            ...
            // `hasLoading` in the route tree prefetch response. (However, this
            // same revalidation logic will eventually apply to
            // <Link prefetch={true}>, so we need to know how to handle this
            // case regardless.)
